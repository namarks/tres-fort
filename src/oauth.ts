...
function consentPage(params: Record<string, string>, error?: string): string {
  const hidden = Object.entries(params)
    ...
    .join('');
  return `<!doctype html><html><head><meta charset="utf-8"><title>tres-forte</title>
...
<h1>Connect tres-forte</h1><p>Enter the owner passphrase to let Claude coach you.</p>
