...
describe('expanded exercise catalog (0007)', () => {
  it('expands the catalog to 280 exercises (12 + 5 + 114 + 7 + 108 + 8 + 22 + 4)', async () => {
    ...
    // 0033 = 22 gymnastic-strength rows,
    // 0049 = 4 thruster / dumbbell push press / renegade row rows.
